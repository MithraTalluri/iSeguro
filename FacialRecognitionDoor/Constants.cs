namespace FacialRecognitionDoor
{
    ...
    public static class GeneralConstants
    {
        ...
        public const string OxfordAPIKey = "970c181ba3724c7b96752fb8b876b261";
        ...
        public static string IntruderFolderName = "Facial Recognition Door Intruderlist";
    }
    ...
    {
        public const string InitialGreetingMessage = "Welcome to the iSeguro! speech has been initialized.";
        ...
        {
            return "Welcome " + visitorName + "! You are authorised to be here,I will open the door";
        }
    }
